...
Para hacer el mismo cálculo en R se realizó lo siguiente en el script `sample-size-murray-larry.R`:
...
Se realizó en el siguiente script `sample-size-proportions-zhang-hartmann`. Vamos a necesitar dos paquetes:
